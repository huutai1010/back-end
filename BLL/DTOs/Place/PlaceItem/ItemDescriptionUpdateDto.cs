...
{
    public class ItemDescriptionUpdateDto
    {
        public string? LanguageCode { get; set; }
        public string? NameItem { get; set; }
    }

    public class ItemDescriptionUpdateDtoValidator : AbstractValidator<ItemDescriptionUpdateDto>
    {
        public ItemDescriptionUpdateDtoValidator()
        {
