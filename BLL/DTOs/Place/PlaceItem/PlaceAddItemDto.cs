...
namespace BLL.DTOs.Place.PlaceItem
{
    public class PlaceAddItemDto
    {
        ...
        public List<ItemDescriptionAddDto>? ItemDescriptions { get; set; }
    }

    public class PlaceAddItemDtoValidator : AbstractValidator<PlaceAddItemDto>
    {
        public PlaceAddItemDtoValidator()
        {
            ...
            RuleForEach(a => a.ItemDescriptions).SetValidator(new ItemDescriptionAddDtoValidator());
